  ...
  options = {
    ripmod.builder = {
      ...
      hostname = mkOption {
        type = types.str;
        default = "";
        description = "allow to build on this host. it will create a build user.";
      };
      privKeyPath = mkOption {
        type = types.str;
        default = "/etc/ssh/ssh_host_ed25519_key";
        description = "set the path to the private key to connect to the build host. default is the host key";
      };
      keys = mkOption {
