...
in
{
  ...
  config = mkIf cfg.enable {
    environment.systemPackages = [ pkgs.headscale ]; # services.headscale.package, unstable.headscale use unstable if you have a noise private key file
    networking.firewall = {
    ...
    services = {
      headscale = {
        ...
        settings = {
          ...
          derp.server.enabled = false; # https://tailscale.com/kb/1118/custom-derp-servers/
