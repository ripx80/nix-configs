    ...
    services.grafana = {
      ...
      provision = {
        ...
        datasources.settings = {
          apiVersion = 1;
          # https://github.com/grafana/grafana/blob/master/public/app/plugins/datasource/prometheus/types.ts
          datasources = [
            {
              name = "Prometheus";
              type = "prometheus";
              ...
              jsonData.timeInterval = "1m"; # must be the same as exporter: https://github.com/grafana/grafana/issues/29858
            }
            {
              name = "Loki";
              type = "loki";
